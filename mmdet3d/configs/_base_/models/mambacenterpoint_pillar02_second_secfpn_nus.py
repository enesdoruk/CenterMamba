...
from mmdet3d.models.backbones.visionmamba import VisionMamba
...
from mmdet3d.models.dense_heads.centerpoint_head import (CenterHead,
                                                         SeparateHead)
from mmdet3d.models.detectors.mambacenterpoint import MambaCenterPoint
...
model = dict(
    ...
    pts_middle_encoder=dict(
        type=PointPillarsScatter, in_channels=64, output_shape=(224, 224)),
    pts_backbone=dict(
        type=VisionMamba,
        in_dim=64,
        in_chans=64,
